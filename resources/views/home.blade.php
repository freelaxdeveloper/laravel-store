...
<div class="col-xl-7 col-md-12">
        ...
        <section class="section extra-margins listing-section mt-2">
            ...
            <h4 class="font-bold"><strong>Лучшее качество на рынке</strong></h4>
                ...
                <div class="row mb-4">
                    ...
                    <div class="row single-post mb-4 mr-3">
                        ...
                        <div class="card mt-4 mx-3">
                            ...
                            <!--Card image-->
                            <div class="view overlay hm-white-slight">
                                <img src="http://oguzov.ru/images/home_gallery_4.jpg" class="img-fluid" alt="sample image">
                                <a>
                                    <div class="mask waves-effect waves-light"></div>
                                </a>
                            </div>
                    ...
                    <div class="row single-post mb-4 mr-3">
                        ...
                        <div class="card mt-4 mx-3">
                            ...
                            <!--Card image-->
                            <div class="view overlay hm-white-slight">
                                <img src="http://oguzov.ru/images/home_gallery_1.jpg" class="img-fluid" alt="sample image">
                                <a>
                                    <div class="mask waves-effect waves-light"></div>
                                </a>
                            </div>
