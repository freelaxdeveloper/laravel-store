...
( function( $ ) {
	Timeline = {
      ...
      var getTranslate = -(itemSize * self.get_current()) - (-listSize / 7);
      // console.log('getTranslate', getTranslate);
      // console.log('itemSize', itemSize);
      // console.log('listSize', listSize);
      // console.log('self.get_current()', self.get_current());
			var totalSize = itemSize * (self.get_count());
			//getTranslate = 0 - (self.get_current() * 15);
